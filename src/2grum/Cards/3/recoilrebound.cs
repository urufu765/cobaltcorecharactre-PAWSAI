...
/// Bruno.
/// </summary>
public class RecoilRebound : Card, IRegisterable
{
    ...
    {
        int x = s.ship.Get(ModEntry.Instance.Status_Hamper.Status) + s.ship.Get(ModEntry.Instance.Status_Recoil.Status);
        return upgrade switch
        {
            ...
            [
                new AVariableHint
                {
                    ...
                    secondStatus = ModEntry.Instance.Status_Hamper.Status
                },
                new AStatus
                {
